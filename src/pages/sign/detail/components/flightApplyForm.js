...
const FlightApplyForm = ({ formData, flightData, originFlightData, newFlightData, signHistory, signFormSubmit, category, id }) => {
...
const mapStateToProps = ( state ) => {
  const { formData, flightData, originFlightData, newFlightData, signHistory, category } = state.signReducer.applyTicketSignReducer;
  return{ formData, flightData, originFlightData, newFlightData, signHistory, category }
}
